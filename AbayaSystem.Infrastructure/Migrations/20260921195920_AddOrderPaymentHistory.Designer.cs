...
namespace AbayaSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260921195920_AddOrderPaymentHistory")]
    partial class AddOrderPaymentHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbayaSystem.Core.Order", b =>
                {
                    ...
                    b.Property<bool>("IsReplenishment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AbayaSystem.Core.OrderPayment", b =>
                {
            ...
            modelBuilder.Entity("AbayaSystem.Core.ReadymadeSale", b =>
                {
                    b.Property<int>("ReadymadeSaleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReadymadeSaleId"));
                    ...
                    b.HasKey("ReadymadeSaleId");

                    b.HasIndex("BranchId");

                    b.ToTable("ReadymadeSales", (string)null);
                });
            ...
            modelBuilder.Entity("AbayaSystem.Core.SheilaTran", b =>
                {
                    ...
                    b.Property<int?>("ReturnOfSheilaTranID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReturnOfSheilaTranID");
            ...
            modelBuilder.Entity("AbayaSystem.Core.SheilaTran", b =>
                {
                    b.HasOne("AbayaSystem.Core.SheilaTran", "ReturnOfSheilaTran")
                        .WithMany("Returns")
                        .HasForeignKey("ReturnOfSheilaTranID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ReturnOfSheilaTran");
